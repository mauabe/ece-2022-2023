export const articlesNews = [
  ...
  },
  {
    ...
    articleHeadlineTwo:'2022 AP-S Harrington-Mittra Award in Computational EM and Outstanding Educator Award',
    articleHeadlineThree: '',
    articleCallout1: '',
    articleCallout2: '',
  ...
  articleAuthor: '',
  articleCaption1: 'Hybrid Dynamics — Deconstruction and Aggregation project funded by the DoD.',
  articleCaption2: '',
  articleCaption3: '',
  ...
  articleImageCred: '',
  articleAuthor: '',
  articleCaption1: 'Semi and UCLA Chips develop Heterogeneous Integration Roadmap.',
  articleCaption2: '',
  articleCaption3: '',
